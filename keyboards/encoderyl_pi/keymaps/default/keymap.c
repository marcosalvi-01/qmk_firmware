...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_NUMBERS] = LAYOUT(
        _______, _______, _______, _______,         KC_7, KC_8, KC_9, _______,
        KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL,         KC_4, KC_5, KC_6, IT_CIRC,
        _______, _______, _______, _______,         KC_1, KC_2, KC_3, _______,
    ...
    */
    [_SYMBOLS] = LAYOUT(
        _______, _______, _______, _______,                     IT_LABK, IT_LCBR, IT_AMPR, IT_DLR,  // TODO
        KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL,                     IT_PERC, IT_LPRN, IT_PLUS, IT_PIPE,
        _______, _______, _______, _______,                     IT_EQL,  IT_LBRC, IT_EXLM, IT_ASTR,
    ...
    */
    [_GAME] = LAYOUT(
        KC_Q, KC_W, KC_F,         KC_P,                   KC_H,    KC_U,   TD(TD_Y_CLIP), TO(_BASE),
        KC_A, KC_R, KC_S,         KC_T,                   KC_N,    KC_E,   KC_I,          KC_O,
        KC_Z, KC_X, KC_C,         KC_D,                   KC_L,    IT_DOT, IT_COMM,       TD(TD_MPLY_MNXT_MPRV),
